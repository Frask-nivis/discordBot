...
class GroqChat(commands.Cog):
    ...
    async def _see_history(
        self,
        channel: object | None,
        minutes: int = CHANNEL_HISTORY_MINUTES,
        query: str = "",
        ...
        try:
            ...
            minutes = CHANNEL_HISTORY_MINUTES
    ...
    def _tool_definitions(self) -> list[dict]:
        return [
            ...
            },
            {
                ...
                "function": {
                    "name": "seehistory",
                    "description": "Baca history terbaru channel Discord aktif saat konteks belum cukup; maksimal 60 menit dan 100 pesan.",
                    "parameters": {
                        "type": "object",
                        "properties": {
                            "minutes": {"type": "integer", "minimum": 1, "maximum": 60, "description": "Rentang history dalam menit."},
    ...
    async def _tool_executor(
        ...
        if name == "seehistory":
            return await self._see_history(
                channel,
                arguments.get("minutes", CHANNEL_HISTORY_MINUTES),
                    ...
                    try:
                        ...
                        if activity is not None:
                            ...
                            if call.function.name == "search_web":
                                ...
                                detail = f"Membaca history {arguments.get('minutes', CHANNEL_HISTORY_MINUTES)} menit..."
