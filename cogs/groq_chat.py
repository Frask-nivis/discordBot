...
class GroqChat(commands.Cog):
    ...
    async def _ask_groq(
        ...
        system_prompt = FERRA_SYSTEM_PROMPT.replace("{CREATOR_NAME}", CREATOR_NAME)
    ...
    async def on_message(self, message: discord.Message) -> None:
        ...
        answer = await self._ask_with_activity(
            ...
            message.guild,
            message.author,
            self._channel_context_for(getattr(message.channel, "id", None)),
        )
    ...
    async def ask_groq(
        ...
        answer = await self._ask_with_activity(
            ...
            channel_context=self._channel_context_for(getattr(interaction.channel, "id", None)),
        )
    ...
    async def ferra_text(self, ctx: commands.Context, *, question: str) -> None:
        ...
        answer = await self._ask_with_activity(
            ...
            ctx.guild,
            ctx.author,
            self._channel_context_for(getattr(ctx.channel, "id", None)),
        )
